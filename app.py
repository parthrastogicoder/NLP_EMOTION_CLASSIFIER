...
st.image("pics/comparison_bar.png", use_column_width=True)
...
st.image("pics/output.png", use_column_width=True)
st.markdown('<div class="image-caption">Class Distribution 1</div>', unsafe_allow_html=True)
st.image("pics/output2.png", use_column_width=True)
st.markdown('<div class="image-caption">Class Distribution 2</div>', unsafe_allow_html=True)
st.image("pics/output3.png", use_column_width=True)
st.markdown('<div class="image-caption">WordCloud before preprocessing</div>', unsafe_allow_html=True)
st.image("pics/output4.png", use_column_width=True)
st.markdown('<div class="image-caption">WordCloud after preprocessing</div>', unsafe_allow_html=True)

st.markdown('<div class="subheader">ROC Curves</div>', unsafe_allow_html=True)
st.image("pics/rocnb.png",  use_column_width=True)
st.markdown('<div class="image-caption">ROC Curve: Naive Bayes</div>', unsafe_allow_html=True)
st.image("pics/roclogreg.png", use_column_width=True)
st.markdown('<div class="image-caption">ROC Curve: Logistic Regression</div>', unsafe_allow_html=True)
st.image("pics/xgbroc.png", use_column_width=True)
